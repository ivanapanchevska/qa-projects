...
* [Postman Automation tests](https://github.com/ivanapanchevska/qa-projects/blob/master/SQL/README.md) 

Postman is incredable tool that help QA engineers to maintain automation tests that will fullfil API integration. Postman uses Javascript language for writing Test cases.
